...
import { TrialWelcomeModal } from '../modals/TrialWelcomeModal';
import { AppHeader } from '../common/AppHeader';
import { AppFooter } from '../common/AppFooter';
import { ProgressBar } from '../common/ProgressBar';
import { PhaseCard } from '../NovenaTracker/PhaseCard';
import { DayButton } from '../NovenaTracker/DayButton';
...
import { StorageDebug } from '../common/StorageDebug';
import { TrialDebug } from '../common/TrialDebug';
...
interface NovenaTrackingScreenProps {
  onBackToSelection: () => void;
  onUpgradeClick: () => void;
}

const NovenaTrackingScreen: React.FC<NovenaTrackingScreenProps> = ({ onBackToSelection, onUpgradeClick }) => {
  const {
    currentDay,
    completedDays,
    startDate,
    ...
    <ThemeProvider> {/* Updated to use new SubscriptionContext */}
      ...
      <div className="mb-4">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-200 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-lg transition-colors duration-200"
        >
          <Home className="w-5 h-5" />
          <span className="font-medium">Back to Prayer Selection</span>
        </button>
      </div>
...
export default NovenaTrackingScreen;